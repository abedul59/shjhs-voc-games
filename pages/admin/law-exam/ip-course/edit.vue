...
.subject-tag { background: #7c3aed; color: white; padding: 4px 10px; border-radius: 6px; font-weight: bold; font-size: 13px;}
...
.form-section h3 { margin: 0 0 20px 0; border-left: 5px solid #7c3aed; padding-left: 12px; }
...
.personal-bg { background: #f5f3ff; border-color: #c4b5fd; }
