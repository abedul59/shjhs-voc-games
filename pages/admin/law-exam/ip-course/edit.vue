...
const form = ref({
  id: null, subject: '智慧財產權法', topic: '', introduction: '', class_video_link: '', notebook_audio_link: '', document_link: '', notebook_infographic_link: '', notebook_quiz_link: '', notebook_flashcard_link: '', notebook_overall_link: '', summary: '', transcript: '', personal_notes: '', associated_urls: ''
});
...
.subject-tag { background: #7c3aed; color: white; padding: 4px 10px; border-radius: 6px; font-size: 13px; font-weight: bold; }
...
.tabs-nav button.active { background: #7c3aed; color: white; }
...
.form-section h3 { margin: 0 0 20px 0; font-size: 18px; color: #1e293b; border-left: 5px solid #7c3aed; padding-left: 12px; }
...
.btn-add-note { display: block; width: 100%; padding: 12px; background: #f5f3ff; color: #7c3aed; border: 2px dashed #c4b5fd; border-radius: 10px; font-weight: bold; font-size: 15px; cursor: pointer; transition: 0.2s;}
