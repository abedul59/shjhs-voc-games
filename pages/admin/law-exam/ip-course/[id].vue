  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/ip-course" class="btn-back">← 回課程列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/ip-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯內容</NuxtLink>
        </div>
...
.subject-label { background: #7c3aed; color: white; padding: 4px 12px; border-radius: 6px; font-size: 14px; font-weight: 900; }
...
.portal-group h3 { margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #7c3aed; padding-bottom: 8px;}
...
.portal-btn:hover:not(:disabled) { border-color: #7c3aed; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
