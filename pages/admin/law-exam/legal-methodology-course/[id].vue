  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/legal-methodology-course" class="btn-back">← 回列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/legal-methodology-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯</NuxtLink>
        </div>
...
.btn-edit { background: #ecfeff; color: #0891b2; border: 1px solid #67e8f9; }
.subject-label { background: #0891b2; color: white; padding: 4px 12px; border-radius: 6px; font-size: 14px; font-weight: 900; }
...
.intro-card { background: #ecfeff; border-left: 6px solid #0891b2; padding: 20px; border-radius: 12px; margin-bottom: 25px; }
...
.tabs-nav button.active { background: white; color: #0891b2; border-top: 3px solid #0891b2; }
...
:deep(.urls-font a:hover) { background: #ecfeff; border-color: #67e8f9; }

.portal-sidebar { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 20px; padding: 20px; position: sticky; top: 20px; }
.portal-group h3 { margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #0891b2; padding-bottom: 8px;}
...
.portal-btn:hover:not(:disabled) { border-color: #0891b2; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
