...
// 🌟 修改這裡即可適應不同法律
const CONFIG = {
  tableName: 'civil_procedure_law_clauses', // 依序改為 criminal_procedure_law_clauses 或 constitutional_law_clauses
  pageTitle: '民事訴訟法', // 依序改為 刑事訴訟法 或 憲法
  primaryColor: '#d97706', // 橘: #d97706, 綠: #059669, 紫: #7c3aed
  backColor: '#fffbeb',    // 橘: #fffbeb, 綠: #ecfdf5, 紫: #f5f3ff
};
