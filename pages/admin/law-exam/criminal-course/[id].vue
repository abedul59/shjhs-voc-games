...
.tabs-nav button.active { background: white; color: #be123c; border-top: 3px solid #be123c; }
...
.portal-group h3 { margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #be123c; padding-bottom: 8px;}
...
.portal-btn:hover:not(:disabled) { border-color: #be123c; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
