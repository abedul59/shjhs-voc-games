  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/criminal-course" class="btn-back">← 回列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/criminal-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯</NuxtLink>
        </div>
...
.btn-edit { background: #ffe4e6; color: #be123c; border: 1px solid #fecaca; }
.subject-label { background: #be123c; color: white; padding: 4px 12px; border-radius: 6px; font-weight: bold; }
...
.portal-group h3 { border-bottom: 2px solid #be123c; padding-bottom: 8px; margin-bottom: 15px;}
...
.portal-btn:hover:not(:disabled) { border-color: #be123c; }
