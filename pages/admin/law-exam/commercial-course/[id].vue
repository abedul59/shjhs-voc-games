  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/commercial-course" class="btn-back">← 回課程列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/commercial-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯內容</NuxtLink>
        </div>
...
.btn-edit { background: #f0fdfa; color: #0f766e; border: 1px solid #5eead4; }
.subject-label { background: #0f766e; color: white; padding: 4px 12px; border-radius: 6px; font-size: 14px; font-weight: 900; }
...
.tabs-nav button.active { background: white; color: #0f766e; border-top: 3px solid #0f766e; }
...
:deep(.urls-font a:hover) { background: #f0fdfa; border-color: #5eead4; }

.portal-sidebar { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 20px; padding: 20px; position: sticky; top: 20px; }
.portal-group h3 { margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #0f766e; padding-bottom: 8px;}
...
.portal-btn:hover:not(:disabled) { border-color: #0f766e; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
