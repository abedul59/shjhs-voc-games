  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/criminal-procedure-course" class="btn-back">← 回列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/criminal-procedure-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯</NuxtLink>
        </div>
...
.subject-label { background: #059669; color: white; padding: 4px 12px; border-radius: 6px; font-weight: bold; }
...
.portal-group h3 { border-bottom: 2px solid #059669; padding-bottom: 8px; margin-bottom: 15px;}
...
.portal-btn:hover:not(:disabled) { border-color: #059669; }
