  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/criminal-procedure-course" class="btn-back">← 回課程列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/criminal-procedure-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯內容</NuxtLink>
        </div>
...
.subject-label { background: #059669; color: white; padding: 4px 12px; border-radius: 6px; font-size: 14px; font-weight: 900; }
...
.tabs-nav button.active { background: white; color: #059669; border-top: 3px solid #059669; }
...
.portal-group h3 { margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #059669; padding-bottom: 8px;}
...
.portal-btn:hover:not(:disabled) { border-color: #059669; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
