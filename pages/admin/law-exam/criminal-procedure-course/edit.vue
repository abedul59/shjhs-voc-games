...
.subject-tag { background: #059669; color: white; padding: 4px 10px; border-radius: 6px; font-weight: bold; font-size: 13px;}
...
.form-section h3 { margin: 0 0 20px 0; border-left: 5px solid #059669; padding-left: 12px; }
