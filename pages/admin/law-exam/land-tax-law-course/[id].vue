  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/land-tax-law-course" class="btn-back">← 回列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/land-tax-law-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯</NuxtLink>
        </div>
...
.btn-edit { background: #fff1f2; color: #be123c; border: 1px solid #fda4af; }
.subject-label { background: #e11d48; color: white; padding: 4px 12px; border-radius: 6px; font-size: 14px; font-weight: 900; }
...
.tabs-nav button.active { background: white; color: #e11d48; border-top: 3px solid #e11d48; }
...
:deep(.urls-font a:hover) { background: #fff1f2; border-color: #fda4af; }

.portal-sidebar { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 20px; padding: 20px; position: sticky; top: 20px; }
.portal-group h3 { margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #e11d48; padding-bottom: 8px;}
...
.portal-btn:hover:not(:disabled) { border-color: #e11d48; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
