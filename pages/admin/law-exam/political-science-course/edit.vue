...
const form = ref({
  id: null, subject: '政治學', topic: '', introduction: '', class_video_link: '', notebook_audio_link: '', document_link: '', notebook_infographic_link: '', notebook_quiz_link: '', notebook_flashcard_link: '', notebook_overall_link: '', summary: '', transcript: '', personal_notes: '', associated_urls: ''
});
    ...
    <div v-else class="form-body">
      <section v-show="activeTab === 'basic'" class="tab-content">
        <div class="form-section">
          <h3>講次基本資訊</h3>
          <div class="form-group"><label>主題名稱 (必填)</label><input v-model="form.topic" type="text" class="input-field" placeholder="例如：政治學導論" /></div>
...
.subject-tag { background: #8b5cf6; color: white; padding: 4px 10px; border-radius: 6px; font-size: 13px; font-weight: bold; }
...
.tabs-nav button.active { background: #8b5cf6; color: white; }
...
.form-section h3 { margin: 0 0 20px 0; font-size: 18px; color: #1e293b; border-left: 5px solid #8b5cf6; padding-left: 12px; }
...
.personal-bg { background: #f5f3ff; border-color: #c4b5fd; min-height: 200px;}
.btn-add-note { display: block; width: 100%; padding: 12px; background: #f5f3ff; color: #8b5cf6; border: 2px dashed #c4b5fd; border-radius: 10px; font-weight: bold; font-size: 15px; cursor: pointer; transition: 0.2s;}
.btn-add-note:hover { background: #ede9fe; }
...
.save-btn { background: #8b5cf6; color: white; border: none; padding: 15px 40px; border-radius: 12px; font-size: 16px; font-weight: bold; cursor: pointer; box-shadow: 0 4px 10px rgba(139, 92, 246, 0.3); }
