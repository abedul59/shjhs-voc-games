  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/political-science-course" class="btn-back">← 回列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/political-science-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯</NuxtLink>
        </div>
...
.btn-edit { background: #f5f3ff; color: #8b5cf6; border: 1px solid #c4b5fd; }
.subject-label { background: #8b5cf6; color: white; padding: 4px 12px; border-radius: 6px; font-size: 14px; font-weight: 900; }
...
.intro-card { background: #f5f3ff; border-left: 6px solid #8b5cf6; padding: 20px; border-radius: 12px; margin-bottom: 25px; }
...
.tabs-nav button.active { background: white; color: #8b5cf6; border-top: 3px solid #8b5cf6; }
...
:deep(.urls-font a:hover) { background: #f5f3ff; border-color: #c4b5fd; }

.portal-sidebar { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 20px; padding: 20px; position: sticky; top: 20px; }
.portal-group h3 { margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #8b5cf6; padding-bottom: 8px;}
...
.portal-btn:hover:not(:disabled) { border-color: #8b5cf6; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
