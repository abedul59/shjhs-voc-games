...
// 🌟 修改這裡即可適應不同法律
const CONFIG = {
  tableName: 'constitutional_law_clauses', // 依序改為 criminal_procedure_law_clauses 或 constitutional_law_clauses
  pageTitle: '憲法', // 依序改為 刑事訴訟法 或 憲法
  primaryColor: '#7c3aed', // 橘: #d97706, 綠: #059669, 紫: #7c3aed
  backColor: '#f5f3ff',    // 橘: #fffbeb, 綠: #ecfdf5, 紫: #f5f3ff
};
