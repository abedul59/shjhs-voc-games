  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/land-law-course" class="btn-back">← 回列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/land-law-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯</NuxtLink>
        </div>
...
.subject-label { background: #f59e0b; color: white; padding: 4px 12px; border-radius: 6px; font-size: 14px; font-weight: 900; }
...
.tabs-nav button.active { background: white; color: #f59e0b; border-top: 3px solid #f59e0b; }
...
:deep(.urls-font a:hover) { background: #fffbeb; border-color: #fde68a; }

.portal-sidebar { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 20px; padding: 20px; position: sticky; top: 20px; }
.portal-group h3 { margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #f59e0b; padding-bottom: 8px;}
...
.portal-btn:hover:not(:disabled) { border-color: #f59e0b; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
