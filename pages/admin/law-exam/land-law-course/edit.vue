...
// 🌟 配置：土地法規
const form = ref({
  id: null, subject: '土地法規', topic: '', introduction: '', class_video_link: '', notebook_audio_link: '', document_link: '', notebook_infographic_link: '', notebook_quiz_link: '', notebook_flashcard_link: '', notebook_overall_link: '', summary: '', transcript: '', personal_notes: '', associated_urls: ''
});
    ...
    <div v-else class="form-body">
      <section v-show="activeTab === 'basic'" class="tab-content">
        <div class="form-section">
          <h3>講次基本資訊</h3>
          <div class="form-group"><label>主題名稱 (必填)</label><input v-model="form.topic" type="text" class="input-field" placeholder="例如：土地徵收之補償" /></div>
...
.subject-tag { background: #f59e0b; color: white; padding: 4px 10px; border-radius: 6px; font-size: 13px; font-weight: bold; }
...
.tabs-nav button.active { background: #f59e0b; color: white; }
...
.form-section h3 { margin: 0 0 20px 0; font-size: 18px; color: #1e293b; border-left: 5px solid #f59e0b; padding-left: 12px; }
...
.personal-bg { background: #fffbeb; border-color: #fcd34d; min-height: 200px;}
.btn-add-note { display: block; width: 100%; padding: 12px; background: #fef3c7; color: #d97706; border: 2px dashed #fcd34d; border-radius: 10px; font-weight: bold; font-size: 15px; cursor: pointer; transition: 0.2s;}
...
.save-btn { background: #f59e0b; color: white; border: none; padding: 15px 40px; border-radius: 12px; font-size: 16px; font-weight: bold; cursor: pointer; box-shadow: 0 4px 10px rgba(245, 158, 11, 0.3); }
