  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/administrative-course" class="btn-back">← 回課程列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/administrative-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯內容</NuxtLink>
        </div>
...
.subject-label { background: #334155; color: white; padding: 4px 12px; border-radius: 6px; font-size: 14px; font-weight: 900; }
...
.tabs-nav button.active { background: white; color: #334155; border-top: 3px solid #334155; }
...
:deep(.urls-font a:hover) { background: #e2e8f0; border-color: #94a3b8; }

.portal-sidebar { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 20px; padding: 20px; position: sticky; top: 20px; }
.portal-group h3 { margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #334155; padding-bottom: 8px;}
...
.portal-btn:hover:not(:disabled) { border-color: #334155; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
