  ...
  <div class="reader-container">
    ...
    <template v-else-if="noteData">
      <div class="reader-header">
        <div class="nav-bar">
          <NuxtLink to="/admin/law-exam/administrative-course" class="btn-back">← 回列表</NuxtLink>
          <NuxtLink :to="`/admin/law-exam/administrative-course/edit?id=${noteData.id}`" class="btn-edit">⚙️ 編輯</NuxtLink>
        </div>
...
.subject-label { background: #475569; color: white; padding: 4px 12px; border-radius: 6px; font-weight: bold; }
...
.tabs-nav button.active { background: white; color: #475569; border-top: 3px solid #475569; }
...
.portal-group h3 { border-bottom: 2px solid #475569; padding-bottom: 8px; margin-bottom: 15px;}
...
.portal-btn:hover:not(:disabled) { border-color: #475569; }
