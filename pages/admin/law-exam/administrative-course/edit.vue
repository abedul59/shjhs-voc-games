...
const form = ref({
  id: null, subject: '行政法', topic: '', introduction: '', class_video_link: '', notebook_audio_link: '', document_link: '', notebook_infographic_link: '', notebook_quiz_link: '', notebook_flashcard_link: '', notebook_overall_link: '', summary: '', transcript: '', personal_notes: '', associated_urls: ''
});
...
.subject-tag { background: #334155; color: white; padding: 4px 10px; border-radius: 6px; font-size: 13px; font-weight: bold; }
...
.tabs-nav button.active { background: #334155; color: white; }
...
.form-section h3 { margin: 0 0 20px 0; font-size: 18px; color: #1e293b; border-left: 5px solid #334155; padding-left: 12px; }
...
.btn-add-note { display: block; width: 100%; padding: 12px; background: #f1f5f9; color: #334155; border: 2px dashed #cbd5e1; border-radius: 10px; font-weight: bold; font-size: 15px; cursor: pointer; transition: 0.2s;}
.btn-add-note:hover { background: #e2e8f0; }
