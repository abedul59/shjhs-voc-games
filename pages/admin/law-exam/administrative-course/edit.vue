...
.subject-tag { background: #475569; color: white; padding: 4px 10px; border-radius: 6px; font-weight: bold; font-size: 13px;}
...
.tabs-nav button.active { background: #475569; color: white; }
.form-section { background: white; padding: 25px; border-radius: 15px; border: 1px solid #e2e8f0; margin-bottom: 20px; }
.form-section h3 { margin: 0 0 20px 0; border-left: 5px solid #475569; padding-left: 12px; }
