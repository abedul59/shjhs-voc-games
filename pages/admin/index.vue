...
<NuxtLink 
  to="/admin/law-exam" 
  class="flex items-center p-4 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors shadow-sm group"
>
  <div class="p-3 bg-gray-100 rounded-lg group-hover:bg-blue-50 transition-colors text-gray-500 group-hover:text-blue-600">
